...
**Hello Rails React** is a web application that displays a random greeting message on screen. It uses **Rails** for back-end and **React** for front-end and. This repo is for front-end. You can access the back end [HERE](https://github.com/emmanuellmhango/hello-rails-back-end)
